...
public class LicenseAnalyser {
	...
	static {
		...
		System.out.println("nlp.classifiers.licenseclassifier");
	...
	private static LicensePrediction analyse(List<String> ngrams,
		...
		System.out.println("Starting License Analysis");
		...
		System.out.println("Analysing License Groups");
		...
		if (!groupRankings.isEmpty()) {
			...
			System.out.println("Analysing Licenses within group");
			...
			if (!indiviudalRankings.isEmpty()) {
				...
				System.out.println("Analysing those licenses that have headers");
